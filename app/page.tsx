...
import { BRAND_GRADIENT, TEXT_GRADIENT } from "@/components/marketing/brand";
import { Reveal, CountUp, reveal, stagger } from "@/components/marketing/motion";
import {
  Sparkline,
  AreaChart,
  BarChart,
...
import { GradientIcon } from "@/components/marketing/ui";
 ...
 * centerpiece — professional charts (area, bar, line, donut, sparklines).
 *
 * Shared chrome (nav, footer) and the chart/motion primitives live in
 * components/marketing/* so the landing and every marketing sub-page stay
 * pixel-consistent.
 */
